...
MINIMUM_MODERATOR_VOTES = 4
MINIMUM_FEMALE_MODERATOR_VOTES = 2
MINIMUM_DIVERSE_MODERATOR_VOTES = 1

MINIMUM_REVIEW_TEAM_SIZE = 4

CONTRIBUTION_QUORUM = 5

BOARD_GROUP = "Bundesvorstand"
REVIEW_GROUP = "Agora Prüfteam"
